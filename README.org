** table of contents                                                    :TOC:
   - [[#seq-frag---simulate-readscontigs-based-on-reference][seq-frag - simulate reads/contigs based on reference]]
   - [[#bio2svg---plot-bamgffbed-tracks-to-svg][bio2svg - plot bam/gff/bed tracks to svg]]

** seq-frag - simulate reads/contigs based on reference
